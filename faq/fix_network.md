...
На данной странице приведены команды для командной строки, aka CMD или PowerShell (запуск от Администратора) для решения некоторых сетевых ошибок Windows.
