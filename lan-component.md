...
{% hint style="info" %}
**Shark Remote LAN** – это компонент для управления компьютерами в одной локальной сети через один Telegram-бот.\
...
Скачать последнюю версию v1.0 от 23 ноября 2024 года: [Telegram канал с релизами](https://t.me/SharkRemoteVersions/172)

### Версии

* v1.0 — поддерживается начиная с Shark Remote версии 6.0
* v0.1 — (также известная как _Сервер V1_) — поддерживается начиная с Shark Remote версии 5.3 dev 1, начиная с версии 6.0 необходимо использовать Shark Remote LAN v1.0
...
6. После выполнения можно уже слать команды на LAN-компонент. \
   ...
   **/shell**, **/touch**, **/cat**, **/file**, **/dir**, **/mv**, **/cp**, **/fo**, **/del**, **/clean**, **/md**, **/rk**, **/sc**, **/ps**, **/time**, **/kill**, **/kcmd**, **/kps**, **/kpsn**, **/kwsl**, **/kwt**, **/time**, **/abno**\
   \
